...
<body>
<%
	String dbUrl ="jdbc:mysql://mydb.cbs2b1grmlct.us-east-1.rds.amazonaws.com:3306/test";
	String dbUser = "admin";
	String dbPw = "admin1234";
	...
	try{
		...
		String listSql = "SELECT id,name FROM customer";
...
%>
	<tr>
		<td><a href="<%=request.getContextPath()%>/customerlist.jsp?id=<%=listResultSet.getString("id")%>"><%=listResultSet.getInt("id")%></a><td>
